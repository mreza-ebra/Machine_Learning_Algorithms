...
addpath("D/EPFL/Courses/Machine Learning Programming/TP2/check_utils_encr")

clear; 
close all; 
clc;

dataset_path = 'D/EPFL/Courses/Machine Learning Programming/TP2/TP2-KMEANS-Datasets';
rng(42);
seed = rng;
